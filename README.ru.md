...
Для сборки и проверки плагина используйте Node.js 24. В корне репозитория выполните `nvm use` на macOS/Linux, чтобы NVM прочитал `.nvmrc`; в nvm-windows выполните `nvm use 24.20.0`. Затем запустите:
